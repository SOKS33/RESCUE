...
/* ======= Command Line parameters ======= */
  ...
  cmd.AddValue ("x0", "X-coordinate [m] of node 0 (relay)", x0);
  cmd.AddValue ("x1", "X-coordinate [m] of node 1 (destination)", x1);
  cmd.AddValue ("y2", "Y-coordinate [m] of node 2 (source_1)", y2);
  cmd.AddValue ("x3", "X-coordinate [m] of node 3 (source_2)", x3);
  cmd.AddValue ("y3", "Y-coordinate [m] of node 3 (source_2)", y3);
...
/* ======== Positioning / Mobility ======= */
  ...
  positionAlloc->Add (Vector (x0, 0.0, 0.0));
  positionAlloc->Add (Vector (x1, 0.0, 0.0));
  positionAlloc->Add (Vector (0.0, y2, 0.0));
...
/* ============= Applications ============ */
  ...
  NodeContainer sources (nodes.Get (2));
  sources.Add (nodes.Get (3));
  ...
  clientApps = echoClient.Install (sources);
