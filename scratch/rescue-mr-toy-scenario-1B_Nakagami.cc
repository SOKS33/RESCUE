...
int main(int argc, char *argv[]) {
    ...
    cmd.AddValue("dSRD", "total (sum) distance [m] of source to relay and relay to destination", dSRD);
    cmd.AddValue("dSR_to_dRD", "ratio of distances: source to relay and relay to destination", dSR_to_dRD);
    ...
    dSR = dSRD * (dSR_to_dRD / (1 + dSR_to_dRD));
    dRD = dSRD / dSR_to_dRD;
