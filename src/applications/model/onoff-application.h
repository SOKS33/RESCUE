...
#include "ns3/qos-tag.h" //UP modification
...
private:
  ...
  uint8_t         m_up;           //!< User Priority //UP modifiaction
  uint32_t        m_randSendTimeLimit; //!< Limit of the percentage randomization of the send times. //random send time modification
