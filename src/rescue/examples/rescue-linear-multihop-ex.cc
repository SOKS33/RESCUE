...
NS_LOG_COMPONENT_DEFINE("RescueLinearMultihopEx");
...
int main(int argc, char *argv[]) {
    LogComponentEnable("RescueMacCsma", LogLevel(LOG_FUNCTION | LOG_DEBUG | LOG_PREFIX_TIME | LOG_PREFIX_NODE));
    //LogComponentEnable("RescuePhy", LogLevel(LOG_FUNCTION | LOG_DEBUG | LOG_PREFIX_TIME | LOG_PREFIX_NODE) );
    //LogComponentEnable("RescueChannel", LogLevel(LOG_FUNCTION | LOG_INFO | LOG_PREFIX_TIME | LOG_PREFIX_NODE) );
    LogComponentEnable("RescueLinearMultihopEx", LogLevel(LOG_INFO));
    ...
    Config::Connect("/NodeList/*/DeviceList/*/$ns3::RescueNetDevice/Mac/CtsTimeout", MakeCallback(&CtsTimeout));
    Config::Connect("/NodeList/*/DeviceList/*/$ns3::RescueNetDevice/Mac/AckTimeout", MakeCallback(&AckTimeout));
    Config::Connect("/NodeList/*/DeviceList/*/$ns3::RescueNetDevice/Mac/Enqueue", MakeCallback(&Enqueue));
    Config::Connect("/NodeList/*/DeviceList/*/$ns3::RescueNetDevice/Mac/SendDataDone", MakeCallback(&SendDataDone));
