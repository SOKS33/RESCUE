 ...
 */
#ifndef RESCUE_NIST_ERROR_RATE_MODEL_H
#define RESCUE_NIST_ERROR_RATE_MODEL_H
 ...
 */
class RescueNistErrorRateModel : public RescueErrorRateModel
{
public:
  static TypeId GetTypeId (void);

  RescueNistErrorRateModel ();

  virtual double GetChunkSuccessRate (RescueMode mode, double snr, uint32_t nbits) const;
...
#endif /* RESCUE_NIST_ERROR_RATE_MODEL_H */
