...
NS_OBJECT_ENSURE_REGISTERED (RescueErrorRateModel);

TypeId RescueErrorRateModel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::RescueErrorRateModel")
    .SetParent<Object> ()
  ;
  return tid;
}
...
double
RescueErrorRateModel::CalculateSnr (RescueMode txMode, double ber) const
{
