...
#ifndef AP_RESCUE_MAC_H
#define AP_RESCUE_MAC_H
...
namespace ns3 {
     ...
     * \ingroup rescue
     */
    class ApRescueMac : public RescueMac {
    public:
        ApRescueMac();
        virtual ~ApRescueMac();
    ...
    private:
        ...
        std::list<Mac48Address> m_schedules; //<! list of scheduled stations

        std::map<Mac48Address, Time> m_reservedTime; //<! keeps the time reserved for each transmitter
