...
#include "adhoc-rescue-mac-helper.h"
...
AdhocRescueMacHelper::AdhocRescueMacHelper ()
{}

AdhocRescueMacHelper::~AdhocRescueMacHelper ()
{}

AdhocRescueMacHelper
AdhocRescueMacHelper::Default (void)
{
  AdhocRescueMacHelper helper;
  helper.SetType ("ns3::AdhocRescueMac");
  return helper;
}

void
AdhocRescueMacHelper::SetType (std::string type,
...
void 
AdhocRescueMacHelper::Set (std::string n, const AttributeValue &v)
{
  m_mac.Set (n, v);
}

Ptr<RescueMac>
AdhocRescueMacHelper::Create (void) const
{
